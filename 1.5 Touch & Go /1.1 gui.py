    ...
    Screen:
        ...
        BoxLayout:
            ...
            Label:
                ...
                text: 'Status: Menunggu Peta...'
                font_size: '20sp'
                size_hint_y: 0.1
            Image:
                id: map_image # Widget untuk menampilkan gambar peta
                source: ''    # Awalnya kosong
                allow_stretch: True
            Button:
...
"""
    ...
    # ... (fungsi-fungsi lain tidak berubah, kecuali update_status_label) ...
    ...
    def update_status_label(self, screen_name, label_id, new_text):
        if self.root:
            try:
                ...
                # Logika khusus untuk memperbarui gambar peta
                if label_id == 'update_map_image':
                    if 'map_image' in screen.ids:
                        screen.ids.map_image.source = new_text
                        screen.ids.map_image.reload() # Perintahkan Kivy untuk memuat ulang gambar
                        print(f"INFO: [GUI] Gambar peta diperbarui ke {new_text}")
                # Logika biasa untuk memperbarui teks label
                elif screen and label_id in screen.ids:
