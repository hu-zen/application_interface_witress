...
class RosManager:
    def __init__(self, status_callback):
        # Inisialisasi Node ROS hanya sekali
        ...
        # Publisher untuk mengirimkan perintah simpan peta
        ...
        # Thread untuk memantau jika ada proses yang mati mendadak
    ...
    def start_roscore(self):
        """Memulai roscore di thread terpisah, tidak akan memblokir program utama."""
        if self.roscore_process is None:
            ...
            try:
                ...
                time.sleep(3) # Jeda ini aman karena berada di thread terpisah
    ...
    def _monitor_processes(self):
        """Memantau proses di latar belakang."""
        while True:
    ...
    def save_map(self, map_name):
        ...
        # Mengirim pesan ke saver_node.py
